...
message(STATUS "MinGW GNU x32 toolchain loading...")
...
# Detect <Z_MSYS_ROOT_DIR>/mingw32.ini to figure MINGW64_ROOT_DIR
...
set(CMAKE_SYSROOT "${Z_MINGW32_ROOT_DIR}" CACHE PATH "Path to pass to the compiler in the ``--sysroot`` flag." FORCE)
set(CMAKE_SYSROOT_COMPILE "${Z_MINGW32_ROOT_DIR}" CACHE PATH "Path to pass to the compiler in the ``--sysroot`` flag when compiling source files." FORCE)
set(CMAKE_SYSROOT_LINK "${Z_MINGW32_ROOT_DIR}" CACHE PATH "Path to pass to the compiler in the ``--sysroot`` flag when compiling source files." FORCE)
...
find_program(CMAKE_Fortran_COMPILER "${Z_MINGW32_ROOT_DIR}/bin/i686-w64-mingw32-gfortran.exe")
mark_as_advanced(CMAKE_Fortran_COMPILER)

find_program(CMAKE_ASM_COMPILER "${Z_MINGW32_ROOT_DIR}/bin/as.exe")
mark_as_advanced(CMAKE_ASM_COMPILER)

find_program(CMAKE_OBJC_COMPILER "${Z_MINGW32_ROOT_DIR}/bin/i686-w64-mingw32-gcc.exe")
