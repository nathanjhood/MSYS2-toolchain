if(NOT _MSYS_UCRT64_TOOLCHAIN)
    ...
    # # set(ENABLE_UCRT64 ON CACHE BOOL "Enable sub-system: MinGW UCRT x64 <UCRT64>." FORCE)
    ...
    if(ENABLE_UCRT64 AND (MSYSTEM STREQUAL "UCRT64"))
    ...
    set(MSYSTEM_TITLE               "MinGW UCRT x64")                         #CACHE STRING    "MinGW x64: Name of the build system." FORCE)
    set(MSYSTEM_TOOLCHAIN_VARIANT   gcc)                                 #CACHE STRING    "MinGW x64: Identification string of the compiler toolchain variant." FORCE)
    set(MSYSTEM_CRT_LIBRARY         ucrt)                              #CACHE STRING    "MinGW x64: Identification string of the C Runtime variant. Can be 'ucrt' (modern, 64-bit only) or 'msvcrt' (compatibilty for legacy builds)." FORCE)
    ...
    set(MSYSTEM_PREFIX              "/ucrt64")                          #CACHE STRING    "MinGW x64: Sub-system prefix." FORCE)
    ...
    set(MSYSTEM_ROOT                "${Z_UCRT64_ROOT_DIR}")             #CACHE PATH      "MinGW x64: Root of the build system." FORCE)
