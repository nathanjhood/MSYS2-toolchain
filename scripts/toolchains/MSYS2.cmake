...
#]===]
set(ENABLE_MSYS2 ON)
option(ENABLE_MSYS2 ON "Enable the msys2 MinGW x64 environment.")
if(ENABLE_MSYS2)
...
option(ENABLE_MINGW64 OFF "Enable the msys2 MinGW x64 environment.")
if(ENABLE_MINGW64)
...
option(ENABLE_MINGW32 OFF "Enable the msys2 MinGW x64 environment.")
if(ENABLE_MINGW32)
    ...
    set(MINGW32_ROOT                "${MSYS_ROOT}${MINGW32_PREFIX}"     CACHE PATH      "MinGW x32: Root of the build system." FORCE)
endif()
# set(ENABLE_CLANG64 ON)
option(ENABLE_CLANG64 OFF "Enable the msys2 Clang x64 environment.")
if(ENABLE_CLANG64)
    ...
    set(CLANG64_ROOT                "${MSYS_ROOT}${CLANG64_PREFIX}"     CACHE PATH      "Clang x64: Root of the build system." FORCE)
endif()
# set(ENABLE_CLANG32 ON)
option(ENABLE_CLANG32 OFF "Enable the msys2 Clang x32 environment.")
if(ENABLE_CLANG32)
    ...
    set(CLANG32_ROOT                "${MSYS_ROOT}${CLANG32_PREFIX}"     CACHE PATH      "Clang x32: Root of the build system." FORCE)
endif()
# set(ENABLE_CLANGARM64 ON)
option(ENABLE_CLANGARM64 OFF "Enable the MinGW Clang ARM64 environment.")
if(ENABLE_CLANGARM64)
    ...
    set(CLANGARM64_ROOT              "${MSYS_ROOT}${CLANGARM64_PREFIX}"  CACHE PATH      "Clang arm64: Root of the build system." FORCE)
endif()
# set(ENABLE_UCRT64 ON)
option(ENABLE_UCRT64 OFF "Enable the MinGW UCRT x64 environment.")
if(ENABLE_UCRT64)
    ...
    set(UCRT64_ROOT              "${MSYS_ROOT}${UCRT64_PREFIX}"         CACHE PATH      "ucrt x64: Root of the build system." FORCE)
endif()
