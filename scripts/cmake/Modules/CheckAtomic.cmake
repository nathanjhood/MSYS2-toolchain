...
elseif(MSYS_COMPILER_IS_GCC_COMPATIBLE OR CMAKE_CXX_COMPILER_ID MATCHES "XL")
...
if(HAVE_CXX_ATOMICS_WITH_LIB OR HAVE_CXX_ATOMICS64_WITH_LIB)
    ...
    if(LLVM_LINKER_IS_GNULD OR LLVM_LINKER_IS_GOLD OR LLVM_LINKER_IS_LLD OR LLVM_LINKER_IS_MOLD)
        ...
        set(MSYS_ATOMIC_LIB "-Wl,--push-state,--as-needed,-latomic,--pop-state")

    else()

        set(MSYS_ATOMIC_LIB "-latomic")
...
if(NOT MSYS_HAS_ATOMICS)

    message(STATUS "Warning: Project will be built thread-unsafe because atomic builtins are missing")
