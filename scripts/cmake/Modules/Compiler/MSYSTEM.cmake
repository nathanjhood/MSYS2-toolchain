...
if(__COMPILER_MINGW64)
    return()
endif()
set(__COMPILER_MINGW64 1)

message(STATUS "Configuring MinGW x64 Compilers...")
...
macro(__compiler_msystem_gnu lang)
    # Feature flags.
    ...
    if(CMAKE_${lang}_COMPILER_ID STREQUAL "MINGW64" AND _IN_TC AND NOT CMAKE_FORCE_DEPFILES)
    else()
    ...
    if(NOT lang STREQUAL "Fortran")
        string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " -DNDEBUG ") ##-- Fortran doesn't have NDEBUG!
    endif()

    string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " -Os")
    if(NOT lang STREQUAL "Fortran")
        string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " -DNDEBUG") ##-- Fortran doesn't have NDEBUG!
    endif()

    string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " -O2")
    string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " -ggdb")
    if(NOT lang STREQUAL "Fortran")
        string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " -DNDEBUG") ##-- Fortran doesn't have NDEBUG!
    endif()
