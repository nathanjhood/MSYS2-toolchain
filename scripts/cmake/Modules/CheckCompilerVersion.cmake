...
# Include guard...
if(DEFINED MSYS_COMPILER_CHECKED)
    return()
endif()
set(MSYS_COMPILER_CHECKED ON)

if(MSYS_FORCE_USE_OLD_TOOLCHAIN)
    return()
endif()
...
function(check_compiler_version NAME NICE_NAME MINIMUM_VERSION SOFT_ERROR_VERSION)
    ...
    elseif(CMAKE_CXX_COMPILER_VERSION VERSION_LESS SOFT_ERROR_VERSION)
        if(MSYS_TEMPORARILY_ALLOW_OLD_TOOLCHAIN)
...
#endif
int main() { return 0; }
" MSYS_LIBSTDCXX_SOFT_ERROR)

        if(NOT MSYS_LIBSTDCXX_SOFT_ERROR)

            if(MSYS_TEMPORARILY_ALLOW_OLD_TOOLCHAIN)

                message(WARNING "libstdc++ version should be at least ${LIBSTDCXX_SOFT_ERROR} because MSYS will soon use new C++ features which your toolchain version doesn't support. Ignoring because you've set MSYS_TEMPORARILY_ALLOW_OLD_TOOLCHAIN, but very soon your toolchain won't be supported.")

            else()

                message(FATAL_ERROR "libstdc++ version should be at least ${LIBSTDCXX_SOFT_ERROR} because MSYS will soon use new C++ features which your toolchain version doesn't support. You can temporarily opt out using MSYS_TEMPORARILY_ALLOW_OLD_TOOLCHAIN, but very soon your toolchain won't be supported.")
