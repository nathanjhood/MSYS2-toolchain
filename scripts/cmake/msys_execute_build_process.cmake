...
set(Z_MSYS_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES
...
list(JOIN Z_MSYS_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES "|" Z_MSYS_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES)

function(msys_execute_build_process)
    ...
    if(X_PORT_PROFILE)
        ...
        if(DEFINED arg_NO_PARALLEL_COMMAND)
            msys_list(PREPEND arg_NO_PARALLEL_COMMAND "${CMAKE_COMMAND}" "-E" "time")
        endif()
    endif()
    ...
    if(NOT error_code EQUAL "0")
        ...
        if(all_contents MATCHES "${Z_MSYS_EXECUTE_BUILD_PROCESS_RETRY_ERROR_MESSAGES}")
